...
/*
 * This distribution system (Naive) is assuming that populations do NOT have cross regional access to food source. 
 */

public class NaiveFoodDistributionSystem : MonoBehaviour
{
